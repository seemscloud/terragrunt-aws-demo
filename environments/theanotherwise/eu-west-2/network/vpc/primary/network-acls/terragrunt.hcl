...
locals {
  mgmt_cidr_blocks      = ["10.2.255.240/28"]
  node_cidr_blocks      = ["10.2.10.0/24", "10.2.11.0/24", "10.2.12.0/24"]
  peer_lb_cidr_blocks   = ["10.1.20.0/24", "10.1.21.0/24", "10.1.22.0/24", "10.3.20.0/24", "10.3.21.0/24", "10.3.22.0/24"]
  peer_node_cidr_blocks = ["10.1.10.0/24", "10.1.11.0/24", "10.1.12.0/24", "10.3.10.0/24", "10.3.11.0/24", "10.3.12.0/24"]
...
inputs = {
  network_acls = {
    ...
    eks_private = {
      vpc_id = dependency.vpc.outputs.vpc_id
      subnet_ids = [
        dependency.subnets.outputs.subnet_ids["private-eu-west-2a"],
        dependency.subnets.outputs.subnet_ids["private-eu-west-2b"],
        dependency.subnets.outputs.subnet_ids["private-eu-west-2c"],
      ]
      ingress = concat(
        [
          {
