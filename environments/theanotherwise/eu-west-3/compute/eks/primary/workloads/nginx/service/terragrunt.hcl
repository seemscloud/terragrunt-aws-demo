    ...
    nginx = {
      ...
      annotations = {
        ...
        "service.beta.kubernetes.io/aws-load-balancer-subnets" = join(",", [
          dependency.subnets.outputs.subnet_ids["lb-eu-west-3a"],
          dependency.subnets.outputs.subnet_ids["lb-eu-west-3b"],
          dependency.subnets.outputs.subnet_ids["lb-eu-west-3c"],
        ])
