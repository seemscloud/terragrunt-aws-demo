...
dependency "subnets" {
  ...
  mock_outputs = {
    subnet_ids = {
      ...
      "tgw-eu-west-1a"     = "subnet-mock-tgw-a"
      "tgw-eu-west-1b"     = "subnet-mock-tgw-b"
      "tgw-eu-west-1c"     = "subnet-mock-tgw-c"
    }
  }
...
inputs = {
  route_table_associations = {
    ...
    "tgw-eu-west-1a" = {
      subnet_id      = dependency.subnets.outputs.subnet_ids["tgw-eu-west-1a"]
      route_table_id = dependency.route_tables.outputs.route_table_ids["tgw"]
    }
    "tgw-eu-west-1b" = {
      subnet_id      = dependency.subnets.outputs.subnet_ids["tgw-eu-west-1b"]
      route_table_id = dependency.route_tables.outputs.route_table_ids["tgw"]
    }
    "tgw-eu-west-1c" = {
      subnet_id      = dependency.subnets.outputs.subnet_ids["tgw-eu-west-1c"]
      route_table_id = dependency.route_tables.outputs.route_table_ids["tgw"]
    }
  }
}
